...
<head>
    ...
    <title>Ajouter une Viennoiserie</title>
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('images/croissant11.jpg'); /* Image de fond pour le body */
...
<div class="form-container">
    ...
    <form action="AjoutVan" method="POST">
        ...
        <input type="text" id="viennoiserieName" name="viennoiserieName" placeholder="Entrez le nom de la viénnoiserie" required>
