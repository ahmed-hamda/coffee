...
public class ViennoiseriePublisher {
	 private List<souscripteur> souscripteur = new ArrayList<>();
	    private List<String> notifications = new ArrayList<>();
	    private static final ViennoiseriePublisher instance = new ViennoiseriePublisher();

	    public static ViennoiseriePublisher getInstance() {
	        return instance;
	    }
